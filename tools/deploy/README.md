...
The image used for the processing step should be tagged `>=2024.08.22` (convention is to start tags with the date of build), as that allows for detection of errors that occur during the critical phase of processing (final result write)
...
| `skip_oco2_tfp`                   | Boolean       | If true and `global_product` is false, only generate target-focused products from OCO-3 CO2 data.                                                                                                                                                                                                | No        | `false`                    |
...
| `image_tag`                       | String        | Docker image tag version to use for data processing, sync and restore. Format: "YYYY.MM.DD\[-\[a-z0-9-_\]+\]". Minimum version: 2024.08.22                                                                                                                                                       | Yes       |                            |
