...
| `mprof_interval`              | Number        | Number of seconds between log reports of memory consumption in the processing stage. Must be an integer between 10 and 3600 (-1 to disable)                                                                                                                                                      | No        | -1                       |
