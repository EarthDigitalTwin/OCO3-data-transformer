...
The image used for the processing step should be tagged `>=2024.06.06` (convention is to start tags with the date of build), as that allows for detection of errors that occur during the critical phase of processing (final result write)
...
| `s3_target_config_key`            | String        | Key for the target config (JSON file) object in S3                                                                                                                                                                                                                                               | No        | `deploy/targets.json`    |
| `s3_target_config_source`         | String        | Path to source target JSON file to copy to S3                                                                                                                                                                                                                                                    | Yes       |                          |
...
| `image_tag`                       | String        | Docker image tag version to use for data processing, sync and restore. Format: "YYYY.MM.DD\[-\[a-z0-9-_\]+\]". Minimum version: 2024.06.06                                                                                                                                                       | Yes       |                          |
