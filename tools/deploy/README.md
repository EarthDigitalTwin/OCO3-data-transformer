...
The image used for the processing step should be tagged `>=2024.10.01` (convention is to start tags with the date of build), as that allows for detection of errors that occur during the critical phase of processing (final result write)
