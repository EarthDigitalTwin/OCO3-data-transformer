...
variable "image_tag" {
  type        = string
  description = "Docker image tag version to use for data processing, sync and restore. Format: <tag>. <tag> should be formatted as \"YYYY.MM.DD[-[a-z0-9-_]+]\". Minimum version: 2025.02.26"
  ...
  validation {
    condition     = element(sort([substr(var.image_tag, 0, 10), "2025.02.26"]), 0) == "2025.02.26"
